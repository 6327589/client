<script setup>
import { uploadAvatarImage } from 'api/common'
import { ElMessage } from 'element-plus'
import { ref, watch, reactive } from 'vue'
// import usePreviewStore from '@/stores/preview'
import { getImageType, getImagePixel } from 'utils/file'
...
const uploadFiles = async (files) => {
  ...
  fileRes.url = res.public_url
  fileRes.file_id = res.file_id
...
//   previewStore.showPreviewImage([fileRes.url], 0)
// }
</script>
  ...
  <div class="upload-one-image">
    <template v-if="props.selectType === 'plus'">
      <div class="preview-box" v-if="fileRes.url">
        <img :src="fileRes.url" class="img" alt="" />
    ...
    <el-button v-else :loading="uploadLoading" @click="handleClick">{{props.title}}</el-button>
