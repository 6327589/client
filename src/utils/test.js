import parser from './queryParse.js'
...
// const queryStr = 'ANCS:(功) and TA:(智能 OR 医学) AND DESC:(手术 NOT (疾病 OR 发明))'
//  '{"op":"AND","exprs":[{"key":"ANCS","value":["功"]},{"op":"OR","exprs":[{"key":"TA","value":["智能"]},{"key":"TA","value":["医学"]}]},{"op":"AND","exprs":[{"key":"DESC","value":["手术"]},{"op":"OR","exprs":[{"op":"NOT","key":"DESC","value":["疾病"]},{"op":"NOT","key":"DESC","value":["发明"]}]}]}]}'
